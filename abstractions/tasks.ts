import type { LoggingMessageBus } from "./message-bus.ts";
...
export interface TaskBuilder {
    ...
    continueOnError(condition: boolean | ((states: TaskStates) => boolean) | ((states: TaskStates) => Promise<boolean>)): this;
}

export interface TaskCollection extends Iterable<Task>, Record<string, unknown> {
    ...
    set(index: number, task: Task) : this 
